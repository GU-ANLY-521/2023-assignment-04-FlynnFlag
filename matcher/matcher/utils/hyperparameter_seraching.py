...
for item in items:
    ...
    raw_score3.append(LevenshteinScorer(item.name1,item.name2,threshold=3)._score())
    res3.append(LevenshteinScorer(item.name1,item.name2).score())
